...
As shown on the figure below, the proposed solution is a three-step process with the goal of generating and keeping only high-quality data samples that cover all possible use cases.
