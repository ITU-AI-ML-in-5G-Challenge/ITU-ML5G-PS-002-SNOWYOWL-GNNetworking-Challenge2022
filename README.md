...
As shown on the figure below, the proposed solution is a three-step process with the goal of generating and keeping only high-quality data samples that cover all possible use cases. A detailed description of our solution can be found [here](https://github.com/ITU-AI-ML-in-5G-Challenge/ITU-ML5G-PS-002-SNOWYOWL-GNNetworking-Challenge2022/blob/main/report%20and%20presentation/report_snowyowl.pdf).
